...
import type { SlideFeatures as SlideFeaturesType, Theme } from "@/lib/types";
import { getThemeStyles } from "./theme-utils";
import { Check } from "lucide-react";

interface SlideFeaturesProps {
  data: SlideFeaturesType;
  theme: Theme;
  brandColor: string;
...
export const SlideFeatures = forwardRef<HTMLDivElement, SlideFeaturesProps>(
  function SlideFeatures({ data, theme, brandColor, isPlaceholder }, ref) {
